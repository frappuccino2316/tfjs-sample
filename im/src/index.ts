...
tf.tidy(() => {
  // const bigMess: Tensor3D = tf.randomUniform([100, 100, 3]);

  // const tensorOne = tf.fill([100, 100, 1], 0.2);
  // const tensorTwo = tf.fill([100, 100, 1], 0.5);
  // const tensorThree = tf.fill([100, 100, 1], 0.8);

  const tensorOne = tf.fill([100, 100, 1], 0.7);
  const tensorTwo = tf.fill([100, 100, 1], 0.1);
  const tensorThree = tf.fill([100, 100, 1], 0.7);
